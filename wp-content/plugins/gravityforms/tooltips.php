...
$__gf_tooltips = array(
	...
	'import_select_file'                          => '<strong>' . __( 'Select Files', 'gravityforms' ) . '</strong>' . __( 'Click the file selection button to upload a Gravity Forms export file from your computer.', 'gravityforms' ),
